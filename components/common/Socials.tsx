        ...
        <div className="pt-2 pb-8 grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3 w-4xl">
            {SOCIALS.map((social) =>
                <Link
                    ...
                    className=" font-mono border rounded-sm border-amber-600/20 hover:border-amber-500/50 hover:bg-amber-600/5 transition-all duration-200 hover:scale-105 hover:shadow-[0_0_18px_rgba(245,158,11,0.35),inset_0_0_10px_rgba(245,158,11,0.08)] hover:animate-pulse p-2 flex gap-3 items-center group"
                >
